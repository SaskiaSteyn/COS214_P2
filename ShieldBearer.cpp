...
Soldiers *ShieldBearer::clonis() {
    ShieldBearer * newShielBearer = new ShieldBearer(this->healthPerSoldier, this->damagePerSoldier, this->defencePerSoldier, this->amountOfSoldiersPerUnit,
                                                     this->unitName);
...
void ShieldBearer::prepare() {
    //Equips a shield
    this->hasShield = true;
    cout << this->unitName << " has equipped a shield ⛨" << endl;
}
...
int ShieldBearer::dealDamage(int damageDealt) {
    ...
    if(this->enemy->getType() == "ShieldBearer"){
        cout << this->unitName << " fought a shield bearer and they fought to a stalemate" << endl;
